...
class Solution {
    ...
    private void removeRoomsReady(Booking booking, 
                                  PriorityQueue<LocalTime> roomCleaningEndTimes) {
        
        //10분 퇴실 + 청소 10분 | 20분 입실 - 가능해야함
        while (!roomCleaningEndTimes.isEmpty() 
               && !roomCleaningEndTimes.peek().isAfter(booking.startTime)) {
    ...
    static class Booking {
        ...
        private static LocalTime convertStringToLocalTime(String stringTime) {
            ...
            return LocalTime.of(Integer.parseInt(hourAndMinute[0]), 
